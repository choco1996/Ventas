...
Public Class VentasCredito
    ...
    Private Sub insert1()
        ...
        For Each row In dt.Rows
            ...
            i = i + 1
            Dim consult2 As String = "INSERT INTO ventas_creditodetalle  (num_detalle, idventacredito, idproducto, cantidad, precio)VALUES (@num,@idventacredito,@idproducto,@cantidad,@precio)"
            Dim cmd2 As New SqlCommand(consult2, con)
            cmd2.Parameters.AddWithValue("@num", CInt(i))
            cmd2.Parameters.AddWithValue("@idventacredito", CInt(txtcodigo.Text))
